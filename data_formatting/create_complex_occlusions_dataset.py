...
dataset_save_location = "/media/wmandil/Data/Robotics/Data_sets/open_images_mask_dataset_foods/"
os.makedirs(dataset_save_location, exist_ok=True)

# Process each image-mask pair
for img_path, mask_path in output_pairs[:5000]:
    try:
        ...
        save_path = os.path.join(dataset_save_location, os.path.basename(img_path).replace(".jpg", ".png"))
